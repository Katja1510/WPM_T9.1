...
Am Institut für Archäologische Wissenschaften in Bochum werden alle eingehenden Rechnungsbeträge im Sekretariat vorkontiert und die bearbeitete Rechnung an die Finanzbuchhaltung der Universitätsverwaltung per Hauspost gesendet. Die Rechnung muss im Original vorhanden sein, damit sie beglichen werden kann. Elektronische Rechnungen, z. B. Pdf-Dokumente als Mail-Anhang zählen nicht als Originalrechnung und dürfen dementsprechend nicht bearbeitet werden. Der gesamte Prozess von der Rechnungsbearbeitung ausgehend, über die Vorkontierung im Institut und zur endgültigen Verbuchung des Betrags auf das korrekte Konto in der Universitätsverwaltung bis hin zur abschließenden Zahlung des Rechnungsbetrags an den Lieferanten ist veraltet und kann mitunter einige Wochen dauern.

##### 4.2. Wünschenswerter Zustand

Für die Rechnungsbearbeitung wünsche ich mir sowohl eine Vereinfachung als auch eine Beschleunigung durch Automatisierungsprozesse, durch ein elektronisches Datenmanagement. Beispielsweise könnte eine Umstellung auf ausschließlich elektronische Rechnungen effizienter sein, da diese schnell zugesendet, abgespeichert und wieder aufgerufen werden können. Auch die Weiterverarbeitung der Rechnung ist effizienter, da weder eine Bearbeitung von Papierrechnungen mit Stempel und Vorkontierungsblatt nötig sind, noch Transportwege durch die Hauspost zur Verwaltung anfallen. Die Prozesse können auf diese Weise abgekürzt und Rechnungsbeträge schneller verbucht werden. So erhält der Lieferant nicht erst nach ein paar Wochen, sondern bereits nach wenigen Tagen sein Geld. Hinzu kommt, dass elektronische Rechnungen umweltschonender sind, weil der Lieferant keine Papierrechnung mehr ausdrucken muss und auch der Transport der Originalrechnungen mit der Hauspost entfällt. Dies bedeutet sowohl eine zeitliche als auch eine umweltschonenden Verbesserung, da der RUB-Fahrdienst unsere Rechnungen dann nicht mehr von unserem Standort "Am Bergbaumuseum 31" zur Kreditorenbuchhaltung, die sich in der Nähe des Hauptbahnhofs befindet, bringen muss, um danach wieder zurück zum RUB-Campus zu fahren. 

#### 5. Fazit

Wie in den vorangegangen Kapiteln deutlich wurde, sind Ideen vorhanden, die Optimierung der Prozesse in der Archäologischen Bibliothek voranzutreiben. Für die jeweilige Umsetzung sind zum einen jedoch die notwendigen Kapazitäten bereitzustellen sowie professionelle Unterstützung notwendig, da tiefgreifende IT-Kenntnisse nicht vorhanden sind. Auch die Optimierung der Arbeitsabläufe könnte daran scheitern, dass kein adäquates Wissen über die Möglichkeiten brauchbarer Bibliothekssoftware abrufbar ist. Da der Markt, Softwareanwendungen betreffend, mittlerweile riesig und ein Überblick mit nur sehr marginalen IT-Kenntnissen äußerst schwierig zu erlangen ist, wäre eine Beratung durch einen professionellen Ansprechparter der UB bzgl. meiner Ideen wünschenswert, so dass wir in unserer Bibliothek sobald wie möglich viele der genannten Ideen umsetzen können, denn es besteht eine Unsicherheit, welche Programme für unsere Zwecke am besten geeignet sind und welche sich am besten mit den bereits vorhandenen verknüpfen lassen. Bei den Rechnungen sieht es anders aus, denn es existieren Buchhaltungsprogramme, wie z. B. Collmex oder Diamant, die elektronische Rechnungen automatisch einlesen. Beim Buchungsvorgang zeigt das Programm die betreffende Rechnung im Pdf-Format und den zu verbuchenden Rechnungsbetrag an. Dann schlägt das Programm eine Buchung zur Rechnung vor und fragt, welcher Betrag auf welches Konto gebucht werden soll? Wenn der Anwender den Vorschlag bestätigt, wird die Buchung vollzogen und der Lieferant erhält seine Zahlung zeinah, ohne dass mehrere Wochen vergehen und die Umwelt mit unnötigen Papierrechnungen belastet wird. Es stellt sich abschließend nur die Frage, ob diese beispielhaft erwähnten Programme auch mit vorhandenen Programmen kompatibel sind. Das herauszufinden, sollte jedoch die Bibliothek nicht vor große technische Probleme stellen.
